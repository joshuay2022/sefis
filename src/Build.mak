...
#LIB_SSL		="F:/P_Files/OpenSSL-Win32/lib/libssl.lib"
#LIB_CRYPTO	="F:/P_Files/OpenSSL-Win32/lib/libcrypto.lib"
...
INCLUDE_PATH	="F:/P_Files/OpenSSL-Win32/include"
LIBRARY_PATH	="F:/P_Files/OpenSSL-Win32/lib"
OPENSSL_INCLUDE	= /I $(INCLUDE_PATH)
OPENSSL_LIBS	= /LIBPATH:$(LIBRARY_PATH)
...
clean:
	-del /Q $(PROGPATH) $O\*.exe $O\*.obj $O\*.lib $O\*.exp $O\*.res $O\*.pch $O\*.asm
